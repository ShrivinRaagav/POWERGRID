...
| **Historical_Demand** | Last month's historical demand baseline. | `Numeric Value` | Raw Data | Module 1 | ❌ No (Dropped) |
...
| **Rolling_Max_3** | Engineered pipeline input feature. | `N/A` | Computed | Module 1 | ✔ Yes |
...
| **Supplier** | Vendor providing the material. | `Categorical` | Raw Data | Module 1 | ✔ Yes |
...
| **Trend_Slope** | Statistical signal feature representing trend slope of the demand curve. | `Signal Analysis Statistic` | Quantity_Required | Module 2 | ✔ Yes |
